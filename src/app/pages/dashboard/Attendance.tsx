  ...
  return (
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-3xl font-bold text-black dark:text-white">Présence</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-1">
          Gérer la présence des élèves et étudiants
        </p>
      </motion.div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { title: 'Présents', value: '0', icon: CheckCircle, color: 'bg-green-500' },
          { title: 'Absents', value: '0', icon: XCircle, color: 'bg-red-500' },
          { title: 'Retards', value: '0', icon: Calendar, color: 'bg-yellow-500' },
        ].map((stat, index) => {
      ...
      >
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Sélectionnez une date et une classe pour marquer les présences.
          </p>
        </div>
      </motion.div>
    </div>
